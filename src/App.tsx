      ...
      >
        ...
        <a href="#" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ width: 28, height: 28, position: 'relative', flexShrink: 0 }}>
            ...
            <div style={{ position: 'absolute', inset: 6, border: '1px solid rgba(201,160,66,0.4)', borderRadius: '50%', animation: 'pulse-ring 3s ease-in-out infinite' }} />
          </div>
          <div>
        ...
        {open && isMobile && (
          <motion.div
            ...
            style={{
              ...
              background: 'rgba(6,13,8,0.98)', backdropFilter: 'blur(24px)',
...
const StatsSection = () => {
  const { isMobile } = useBreakpoint();
  return (
    <section style={{ background: '#070e09', borderTop: '1px solid rgba(201,160,66,0.12)', borderBottom: '1px solid rgba(201,160,66,0.12)' }}>
...
const ServicesSection = () => {
  ...
  return (
    <section id="services" style={{ background: '#f5f0e8', padding: `${py} ${px}` }}>
      <div style={{ maxWidth: 1240, margin: '0 auto' }}>
        ...
        >
          <div>
            <div style={{ fontSize: 11, color: '#c9a042', letterSpacing: '0.35em', textTransform: 'uppercase', fontFamily: 'Outfit, sans-serif', fontWeight: 600, marginBottom: 14 }}>
              ── SPECIALIST CARE
            </div>
            <h2 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: isMobile ? 48 : 'clamp(48px, 6vw, 72px)', fontWeight: 300, color: '#0a1f13', lineHeight: 1.05, margin: 0 }}>
              Conditions<br /><em style={{ fontStyle: 'italic', color: '#1a3d2b' }}>We Treat</em>
            </h2>
          </div>
          <div style={{ maxWidth: isMobile ? '100%' : 360, fontSize: 14, lineHeight: 1.85, color: '#3d5a47', fontFamily: 'Outfit, sans-serif', fontWeight: 300 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: cols, gap: 3 }}>
          {SERVICES.map((s, i) => (
            <motion.div
              ...
              style={{ padding: isMobile ? '28px 24px' : '40px 36px', background: '#0a1f13', borderLeft: '2px solid rgba(201,160,66,0.15)', position: 'relative', overflow: 'hidden', cursor: 'pointer' }}
            >
              <div style={{ fontSize: 20, color: 'rgba(201,160,66,0.5)', marginBottom: 14 }}>{s.icon}</div>
              ...
              <p style={{ fontSize: 13, color: 'rgba(250,246,239,0.5)', lineHeight: 1.75, margin: 0, fontFamily: 'Outfit, sans-serif', fontWeight: 300 }}>{s.desc}</p>
              <div className="service-arrow" style={{ position: 'absolute', bottom: 20, right: 24, opacity: 0 }}>
                <ArrowRight size={13} color="#c9a042" />
              </div>
              <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 1, background: 'linear-gradient(90deg, #c9a042, rgba(201,160,66,0))' }} />
            </motion.div>
          ))}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ flexShrink: 0 }}>
          <div style={{ width: isMobile ? 44 : 64, height: isMobile ? 44 : 64, position: 'relative' }}>
            <div style={{ position: 'absolute', left: '50%', top: 0, width: 1, height: '100%', background: '#c9a042', transform: 'translateX(-50%)' }} />
            <div style={{ position: 'absolute', top: '50%', left: 0, height: 1, width: '100%', background: '#c9a042', transform: 'translateY(-50%)' }} />
            <div style={{ position: 'absolute', inset: 10, border: '1px solid rgba(201,160,66,0.35)', borderRadius: '50%' }} />
          </div>
        </div>
  ...
  return (
    <section id="about" style={{ background: '#f5f0e8', padding: `${py} ${px}` }}>
      <div style={{
        ...
        >
          <div style={{ aspectRatio: '3/4', background: 'linear-gradient(145deg, #1a3d2b 0%, #0a1f13 100%)', position: 'relative', overflow: 'hidden' }}>
            <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 20 }}>
              <div style={{ position: 'relative', width: 80, height: 80, animation: 'rotate-slow 20s linear infinite' }}>
                <svg width={80} height={80} viewBox="0 0 80 80">
                  <circle cx={40} cy={40} r={38} fill="none" stroke="rgba(201,160,66,0.2)" strokeWidth={0.5} strokeDasharray="3 6" />
                  <circle cx={40} cy={40} r={26} fill="none" stroke="rgba(201,160,66,0.3)" strokeWidth={0.5} />
                </svg>
              ...
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 18, fontWeight: 300, color: 'rgba(201,160,66,0.4)', letterSpacing: '0.12em' }}>Dr. Wafaa</div>
                <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 18, fontWeight: 300, color: 'rgba(201,160,66,0.4)', letterSpacing: '0.12em', fontStyle: 'italic' }}>Ibrahim</div>
              </div>
            </div>
        ...
        >
          ...
          <p style={{ fontSize: 14, lineHeight: 1.9, color: '#3d5a47', fontFamily: 'Outfit, sans-serif', fontWeight: 300, marginBottom: 32 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 36 }}>
            {CREDENTIALS.map((c, i) => (
              ...
              >
                ...
                <span style={{ fontSize: 13, color: c.highlight ? '#0a1f13' : '#3d5a47', fontFamily: 'Outfit, sans-serif', fontWeight: c.highlight ? 500 : 400 }}>{c.label}</span>
              </motion.div>
            ))}
          </div>
...
const InsuranceSection = () => {
  const { isMobile } = useBreakpoint();
  return (
    <section id="insurance" style={{ background: '#070e09', padding: isMobile ? '60px 20px' : '100px 48px', borderTop: '1px solid rgba(201,160,66,0.1)' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ width: '100%', height: 1, background: 'linear-gradient(90deg, transparent, rgba(201,160,66,0.3) 20%, rgba(201,160,66,0.3) 80%, transparent)', marginBottom: 40 }} />
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 3, justifyContent: 'center' }}>
          {INSURANCE.map((ins, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ borderColor: 'rgba(201,160,66,0.7)', color: '#c9a042' }}
              style={{
            ...
            <form onSubmit={e => e.preventDefault()} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[
                ...
                <input
                  ...
                  style={{
                    background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(201,160,66,0.13)',
                    padding: '15px 18px', color: '#faf6ef', fontSize: 14,
              ...
              <select style={{
                background: 'rgba(10,31,19,0.9)', border: '1px solid rgba(201,160,66,0.13)',
                padding: '15px 18px', color: 'rgba(250,246,239,0.45)', fontSize: 14,
              ...
              <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'stretch' : 'center', gap: isMobile ? 12 : 20, paddingTop: 4 }}>
                <button
                  ...
                  style={{
                    background: '#c9a042', color: '#0a1f13', border: 'none',
                ...
                <span style={{ fontSize: 12, color: 'rgba(250,246,239,0.22)', fontFamily: 'Outfit, sans-serif', textAlign: isMobile ? 'center' : 'left' }}>
...
const Footer = () => {
  const { isMobile } = useBreakpoint();
  return (
    <footer style={{ background: '#060d07', borderTop: '1px solid rgba(201,160,66,0.1)', padding: isMobile ? '32px 20px' : '40px 48px' }}>
      <div style={{
        maxWidth: 1240, margin: '0 auto',
        display: 'flex',
        flexDirection: isMobile ? 'column' : 'row',
